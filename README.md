...
[![NoSQL](https://img.shields.io/badge/-NoSQL-4DB33D?style=flat-square&logo=mongodb&logoColor=white)](https://en.wikipedia.org/wiki/NoSQL)
...
[![Filament](https://img.shields.io/badge/-Filament-F59E0B?style=flat-square&logo=laravel&logoColor=white)](https://filamentphp.com)
[![GrumPHP](https://img.shields.io/badge/-GrumPHP-8892BF?style=flat-square)](https://github.com/phpro/grumphp)
...
- Founder, currently building and operating three products.
- Based in India

## Featured Projects

- **[TiBook](https://tibook.in)**
  *All-in-one business management software for billing, inventory, accounting, CRM, employee management, reporting, and multi-business operations—from one dashboard.*
- **[SuperYou](https://superyou.bio)**
  *An audience commerce platform that helps creators sell digital products, capture leads, automate Instagram DMs, and turn one simple link into a revenue engine.*
- **[Kalory](https://mykalory.com)**
  *AI-powered calorie and nutrition tracking. Snap a meal photo to estimate calories, macros, and portion sizes—without the hassle of manual logging.*
...
- [LinkedIn](https://linkedin.com/in/mr-hitss)
